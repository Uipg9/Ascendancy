...
![Version](https://img.shields.io/badge/version-2.5.1-gold)
...
3. Drop `ascendancy-2.5.1.jar` into your `mods` folder
4. Launch and enjoy!
...
### v2.5.1 - The Replayability Update
- 🎯 **Soul's Craving System**: Each life has a random quest objective (kill X mobs, mine Y ores, etc.) that awards +3 bonus prestige upon completion!
- 📖 **The Chronicle**: A procedural diary that automatically records major events and milestones across all your lives - track your journey!
- 🏆 **Ascension Achievements**: 17 permanent achievements that unlock powerful passive bonuses (damage, speed, mining, XP) that last forever!
- 🐾 **Ancestral Bond**: Carry your beloved tamed pets to your next life! Prestige-gated pet slots (1 at 5 prestige, 2 at 10, 3 at 15).
- 🎨 **Hall of Legends**: New UI screen (press L) to view all your achievements, progress, and unlocked bonuses!
- 🔧 **1.21.11 API Fixes**: Fixed mixin signatures for fall damage and durability systems to match latest Minecraft API changes

### v2.4.4 - Performance & UX Update
- ⚡ **Reduced Teleport Distance**: 50k blocks instead of 1 million - eliminates lag!
- 💰 **Instant Price Updates**: Upgrade costs update immediately after purchase
- 🚦 **Optimized Travel**: Random Z variance reduced to 10k for faster chunk loading
- 📉 **Starting Distance**: Lowered minimum spawn distance to 10k blocks
